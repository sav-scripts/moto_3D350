...
(function(){
    ...
    {
        return MyThreeHelper.getCameraDistance(45, Main.videoWidth, Main.videoHeight, window.innerWidth, window.innerHeight, Main.videoBleed);
    };
    ...
    function onWindowResize()
    {
        ...
        if(_cameraControl)
        {
            ...
            var width = obj.screenWidth - Main.videoBleed;
            var height = obj.screenHeight - Main.videoBleed;
